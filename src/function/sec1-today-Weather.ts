import type { CurrentWeather } from "./typeAPI";
import { weatherStatus } from "./weather_status.js";


export const currentWeather = (namelocation:string, dataCurrentWeather: CurrentWeather)=>{

    let sectionCurrentWeather = document.querySelector(".sec1-today-Weather") as HTMLElement;
